...
function editRole(data){
    ...
    noOfUsers.value = data.noOfUsers
...
async function addEquipment(){
    ...
    formData.append("model_number", modelNo.value);
...
<template>
    <v-container class="text-center mt-12" style="background-color:#E2D2DC">
        <v-card>
                ...
                <v-tabs-window-item :value="1">
                    <div v-if="users == null||users==undefined||Object.keys(users).length == 0" align="center">
                        <v-row>
                            ...
                            <v-col cols="12" md="6" sm="12" >
                                <v-btn class="ma-2" color="#5B4258" icon="mdi-plus" @click="showAddUserDialog = true"></v-btn>
                            </v-col>
                        </v-row>
                    </div>
                    <div v-else>
                ...
                <v-tabs-window-item :value="2">
                    <div v-if="roles==null ||roles==undefined || Object.keys(roles).length == 0" align="center">
                        <v-row>
                            ...
                            <v-col cols="12" md="6" sm="12" >
                                <v-btn class="ma-2" color="#5B4258" icon="mdi-plus" @click="showAddRoleDialog = true"></v-btn>
                            </v-col>
                        </v-row>
                    </div>
                    <div v-else>
                 ...
                 <v-tabs-window-item :value="3">
                    <div v-if="equipment==null ||equipment==undefined || Object.keys(equipment).length == 0" align="center">
                        <v-row>
                            ...
                            <v-col cols="12" md="6" sm="12" >
                                <v-btn class="ma-2" color="#5B4258" icon="mdi-plus" @click="showAddEquipmentDialog = true"></v-btn>
                            </v-col>
                        </v-row>
                    </div>
                    <div v-else>
                ...
                <v-form @submit.prevent >
                    <v-card>
                        ...
                        <v-row>
                                Add User
                                <v-spacer></v-spacer>
                                <v-btn class="ma-2" color="#5B4258" icon="mdi-close" @click="close();"></v-btn>
                            </v-row>
                        </v-card-title>
                        <v-card-text>
                            <v-row>
                ...
                <v-form @submit.prevent >
                    <v-card>
                        ...
                        <v-card-text>
                            <v-row dense>
                                <v-col >
                                    <v-text-field label="Role" v-model="name" required :rules="[rules.required]"></v-text-field>
                                </v-col>
                            </v-row>
                ...
                <v-form @submit.prevent >
                    <v-card>
                        ...
                        <v-card-text>
                            <v-row>
                                <v-col md="6">
                                    <v-text-field label="Equipment Name" v-model="equipmentName" required :rules="[rules.required]"></v-text-field>
                                </v-col>
                                <v-col md="6">
