        ...
        <v-row>
            <v-col md="12">
                <v-form width="50%">
                    <v-row>
                        <v-col md="12">
                               <v-icon color="#5B4258" icon="mdi-alpha-m-circle" size="x-large" class="mt-8"></v-icon> 
                        </v-col>
                    </v-row>
                     <v-row>
                        <v-col>
                    ...
                    <v-row>
                        ...
                        <v-col md="6">
                            <v-select
                            label="Select"
                            :items="['CBD', 'Madaraka', 'Westlands', 'Buruburu']" variant="outlined"
                            ></v-select>
                        </v-col>
                    </v-row>
                    ...
                    <v-row>
                        <v-col md="12">
                             <v-btn color="#5B4258" variant="elevated" >Sign up</v-btn>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col md="12">
